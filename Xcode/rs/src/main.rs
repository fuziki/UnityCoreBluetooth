...
fn main() {
    ...
    let setting_file_name: &str = "../../setting.yml";
    ...
    let input_file_name: &str = "./project.template.yml";
    ...
    let output_file: std::fs::File = File::create("../project.yml").expect("failed to create output file");
